...
export class AdminLayoutComponent implements OnInit {
  ...
  constructor( public location: Location, private testService: TestService, private router: Router) {}

  ngOnInit() {
    // this.testService.deleteAllCookies();
    const user: any = this.testService.getCookie('uid');
    if (user === '') {
        this.router.navigate(['/login']);
    } else {
        //alert(user + ' ' + atob(user));
    }
